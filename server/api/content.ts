export default defineEventHandler(async () => { 
    ...
    let result = {
        jobs : [
            ...
            {company: 'Rb-media', address: 'Overemer 8a', year: '2017(zomer) - 2018(zomer)', position: 'front- & back-end (stage)', content: '<ul><li>Interview met de klant over hun wensen en ontwerp wat de klant wilt.</li><li>Project opstarten samen met mijn project leider.</li><li>Hun cms instellen voor de project.</li><li>Website maken die de data uit hun cms haalt.</li></ul>'},
